...
Mat ThresholdImage(Mat imgOriginal)
{
	Mat imgHSV;
...
Mat ShapeIdentification(Mat imgOriginal, Mat imgThresholded) {
...
int main(int argc, char** argv) {
	...
	while (true) {
		...
		imgThresholded = ThresholdImage(imgOriginal);

		// identify shapes.
		imgTracked = ShapeIdentification(imgOriginal, imgThresholded);
